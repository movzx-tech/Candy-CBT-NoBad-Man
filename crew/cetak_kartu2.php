			...
			<td width='50%'>
				<div style='width:10.4cm;border:1px solid #666;'>
					...
					<table style="text-align:left; width:100%">
						<tr>
							<td class="nama_siswa"valign="top"><center><b> <?= $siswa['nama'] ?></b></center></td>
						</tr>
					</table>
					<table style="text-align:left; width:100%">
						<tr>
						...
						<tr>
							...
							<td class="ukuran" valign='top'>: <?= $siswa['ruang'] ?>
								<div style="padding-top: <?= $setting['kartu_atas'].'px'; ?>; padding-left: <?= $setting['kartu_kiri'].'px'; ?>;" class="ttd"><img  src='<?php echo '../dist/img/ttd.png'.'?date='.time(); ?> ?>' height='<?= $setting['kartu_tinggi'].'px'; ?>' width="<?= $setting['kartu_lebar'].'px'; ?>"></div>
							</td>
						</tr>
