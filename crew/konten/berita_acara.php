...
if ($pengawas['level'] == 'admin') : ?>
	<?php
	$idberita = $_GET['id'];
	$sqlx = mysqli_query($koneksi, "SELECT * FROM berita a LEFT JOIN mapel b ON a.id_mapel=b.id_mapel LEFT JOIN mata_pelajaran c ON b.KodeMapel=c.kode_mapel WHERE a.id_berita='$idberita'");
