	...
	if (isset($_POST['tambahsoal'])) :
		...
		if ($pengawas['level'] == 'admin') {
			...
			if ($cek > 0) :
				...
				$exec = mysqli_query($koneksi, "INSERT INTO mapel (idpk, nama,KodeMapel, jml_soal,jml_esai,level,status,idguru,bobot_pg,bobot_esai,tampil_pg,tampil_esai,kelas,opsi,siswa) VALUES ('$id_pk','$kode_bank','$KodeMapel','$jml_soal','$jml_esai','$level','$status','$guru','$bobot_pg','$bobot_esai','$tampil_pg','$tampil_esai','$kelas','$opsi','$siswa')");
            ...
            Maaf Kode Mapel - Level - Kelas Sudah ada !
				...
				$exec = mysqli_query($koneksi, "INSERT INTO mapel (idpk, nama,KodeMapel, jml_soal,jml_esai,level,status,idguru,bobot_pg,bobot_esai,tampil_pg,tampil_esai,kelas,opsi,siswa) VALUES ('$id_pk','$kode_bank','$KodeMapel','$jml_soal','$jml_esai','$level','$status','$id_pengawas','$bobot_pg','$bobot_esai','$tampil_pg','$tampil_esai','$kelas','$opsi','$siswa')");
												...
												<form action='' method='post'>
													<div class='modal-body'>
														...
														<div class='form-group'>
															...
															<input value="<?= $mapel['nama'] ?>" placeholder="Misal: BINDO_XITK4 atau MTK_XAK2" type='text' id='kode_bank' name='kode_bank' class='form-control' required='true' />
														</div>
														<!-- <div class='form-group'>
