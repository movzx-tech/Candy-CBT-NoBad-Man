						...
						<div id="boxtampil" class='col-md-12'>
							...
							<div class='box box-solid'>
								...
								<div class='box-body'>
									<div class="text-center">
										<div class="row">
											<div class="col-md-12">
												...
												<div class="row">
													<?php if($setting['izin_absen']==1){ ?>
													<a href="<?= $homeurl ?>/absen/" class="btn btn-app btn-primary">
						                <img src="icon_siswa/attendance_sekolah.svg" width="30" height="30"> <b> Absen Sekolah</b>
						              </a>
						              <?php }?>
						              <?php if($setting['izin_info']==1){ ?>
						              <a href="<?= $homeurl ?>/pengumuman/" class="btn btn-app btn-primary">
					              ...
					              <?php if($setting['izin_materi']==1){ ?>
					              	<a href="<?= $homeurl ?>/materi/" class="btn btn-app btn-primary">
						                <img src="icon_siswa/book.svg" width="30" height="30"> <b> Materi Guru</b>
						              </a>
						              <?php }?>
						              <?php if($setting['izin_tugas']==1){ ?>
						              <a href="<?= $homeurl ?>/tugassiswa/" class="btn btn-app btn-primary">
						                <img src="icon_siswa/tugas.svg" width="30" height="30"> <b> Tugas Guru</b>
						              </a>
						              <?php }?>
					              </div>
					              <?php if($setting['izin_absen_mapel']==1){ ?>
					              <div class="row">
					              	<a href="<?= $homeurl ?>/absen_mapel/" class="btn btn-app btn-primary">
					              ...
					              <?php if($setting['izin_pass']==1){ ?>
					              <div class="row">
													<a href="<?= $homeurl ?>/pass/" class="btn btn-app btn-primary">
				...
				<?php elseif ($pg == 'testongoing') : ?>
					...
					if ($cek <> 0) :
						...
						if (isset($_POST['done'])) :
							...
							$da2=$dbb->Status_sudah_ujian($id_siswa,$idmapel,$ac);
							if($da2==1){
					...
					?>
						<div class='row' style='margin-right:-25px;margin-left:-25px;'>
							...
							<!-- tampil popup soal yang sudha di jawab mryes #0d7fa0-->
