...
if (isset($_POST['buat2'])) {
	$filename = 'config/candy_royal.sql';
	$templine = '';
	$lines = file($filename);
...
<body class="hold-transition skin-blue layout-top-nav">
	...
	<div class="wrapper">
		<header class="main-header">
			<nav class="navbar navbar-fixed-top " style="background-color: #00ab61;">
				<div class="container">
					<div class="navbar-header">
						<a href="?" class="animated bounce navbar-brand" style="padding:5px 15px;"><b>CANDY</b> INSTALLER ROYAL</a>
					</div>
				</div>
			</nav>
		</header>
		...
		<!-- Full Width Column -->
		<div class="content-wrapper" style="background:url(dist/img/octo.gif);background-color: white; background-size: cover;">
				...
				<section class="content">
					...
					<div class='row'>
						<div class="animated tada delay-1s login-logo" style='font-size:50px;margin-top:12%;'>
							...
							<img style="padding-top: 0;" src="core/butoijo4.jpg" width="300" >
							</div> -->
							<a href="">WELCOME TO <?= APLIKASI ?></a>
							
						</div>

						<div class="animated tada delay-1s login-logo" style='font-size:20px;'>
							<a href="">Candy ROYAL Alat tempur Laragon Full 4.0.16 dan MariaDB 10.4.12<br>
							PHP V.7.2</a>
						</div>
